...
\begin{frame}{\#3 Neural networks}
  ...
  \begin{itemize}
    ...
    \item \texttt{flax} has a different mindset: compare \href{https://www.tensorflow.org/tutorials/quickstart/beginner\#train_and_evaluate_your_model}{tensorflow} to \href{https://github.com/ThibeauWouters/jax-getting-started/blob/0e4b45133794f86028423b6b4814471e068ef2d3/flax/utils_flax.py\#L183}{flax}
  \end{itemize}
...
\begin{frame}{Conclusion}
  ...
  \begin{itemize}
    \item \texttt{jax} is a great tool
