...
\begin{frame}{Equation of state}
  ...
  Neutron stars uniquely probe the equation of state (EOS) of dense nuclear matter~\cite{Koehn:2024set}
...
\begin{frame}{Electromagnetic counterparts \small (Hauke Koehn, Tim Dietrich) \normalsize}
  ...
  \begin{itemize}
    ...
    \item Code libraries too large to `jaxify' (e.g. \textsc{afterglowpy}~\cite{Ryan:2019fhz})
...
\begin{frame}{Equation of state inference -- parametrization}
  ...
  \begin{itemize}
    \item $n \leq \tfrac12 n_{\rm{sat}}$: fixed
