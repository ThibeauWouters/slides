...
\input{talk_structure.tex}

\section{Part 1: Analyzing GW231109\_235456 in the ET era}
...
\begin{frame}{Constraining EOS from GW231109\_235456}
  ...
  Put information on jester here
...
\begin{frame}{Conclusion (part 1)}
  ...
  \begin{itemize}
    ...
    \item \textsc{jester} can handle individual high SNR signals: efficiently go from NS observations to EOS constraints
  \end{itemize}
  
\end{frame}

\section{Part 2: Neural priors for GW inference}
...
\begin{frame}{Normalizing flows}
  ...
  \begin{itemize}
    ...
    \item Often used in PE, e.g., \textsc{dingo}~\cite{Dax:2021tsq, Dax:2022pxd}, \textsc{nessai}~\cite{Williams:2021qyt,Williams:2023ppp}
...
\begin{frame}{GW170817: Parameter constraints (Gaussian pop.)}
...
\begin{frame}{GW190425: Parameter constraints (Uniform pop.)}
...
\begin{frame}{GW230529: Parameter constraints (Gaussian pop.)}
...
\begin{frame}{Conclusion (part 2)}
  ...
  \begin{itemize}
    \item Flexible way to encode non-trivial prior information
    \item Two highlights:
    \begin{enumerate}
...
\begin{frame}{Conclusion}
  ...
  \begin{enumerate}
    \item \textsc{jester}: from nuclear physics and multimessenger astronomy to EOS constraints
    \item Neural priors: incorporate NS physics into GW inference
  \end{enumerate}
