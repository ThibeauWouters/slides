  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node[fill=customblue, fill opacity=0.75, text opacity=1, rounded corners=10pt, inner sep=15pt] at (current page.center) {
      \begin{minipage}{0.8\textwidth}
        ...
        arXiv:2504.15893, arXiv:2510.22290\\[1ex]
...
\begin{frame}{Tidal deformability}
  ...
  \begin{itemize}
    ...
    \item Leave imprint in gravitational wave signal
...
\begin{frame}{Binary neutron star mergers: GW170817 and GW190425}
  ...
  So far, two confident binary neutron star detections:
...
\begin{frame}{Equation of state inference}
  ...
  \begin{itemize}
    \item To predict neutron star properties, we solve the TOV equations
...
\begin{frame}{Conclusions}
  ...
  \begin{itemize}
    \item GW231109\_235456: sub-threshold binary neutron star candidate in LVK's O4a run
