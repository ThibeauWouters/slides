...
\begin{frame}{Methods -- Equation of state parametrization (1)}
  ...
  \begin{itemize}
    \item At \red{low density}, we use the metamodel: Taylor expansion of energy per nucleon $E/A$~\cite{Margueron:2017eqc,Margueron:2017lup} in\footnote{$n_{\rm{sat}} \equiv 0.16 \ \rm{fm}^{-3}$} $x = (n - n_{\rm{sat}}) / 3n_{\rm{sat}}$
