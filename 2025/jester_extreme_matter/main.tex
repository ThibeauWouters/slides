...
\begin{frame}{Results -- Recovery of nuclear empirical parameters}
  ...
  \begin{itemize}
    ...
    % \item Recover ``true'' EOS with increasingly more NEPs being varied
    ...
    \item Yet, recovered EOSs deviate $<100$ meters, $<10$ in $\Lambda$ from the true EOS $\rightarrow$ observationally indistinguishable % in $[1, 2] \ M_\odot$ range
  \end{itemize}
