...
{
\usebackgroundtemplate{\transparent{0.5}{\includegraphics[width=\paperwidth,height=\paperheight]{tintin_BNS_2.png}}}
...
\begin{frame}{\textsc{Jim}: GPU-accelerated GW parameter estimation}
  ...
  \textsc{Jim}~(\ghlink{GW-JAX-Team/jim}~\texttt{GW-JAX-Team/jim}): gravitational wave parameter estimation~\smallcite{Wong:2023lgb,Wouters:2024oxj}
  ...
  \only<2>{
    ...
    \begin{columns}
      ...
      \begin{itemize}
        ...
        \item Support different GPU samplers
        ...
        \item All $\sim2\times$ -- $10\times$ faster than \textsc{bilby}
      \end{itemize}
...
\begin{frame}{Einstein Telescope}
  ...
  \begin{itemize}
    \vspace{\y}
    \item 100 loudest binary neutron star mergers from 1 year~\smallcite{Branchesi:2023mws}
  \end{itemize}
