...
\begin{frame}{Motivation}
  ...
  \begin{itemize}
    ...
    \item ``we will be able to make statements about how strongly a given detector configuration can constrain deviations from nuclear physics''
  \end{itemize}
...
\begin{frame}{\texttt{jester}: JAX-accelerated EOS inference}
  ...
  \begin{itemize}
    ...
    \item EOS models:
    \begin{itemize}
      \item Fixed crust + metamodel + speed-of-sound (MM+CSE)~\cite{Koehn:2024set,Wouters:2025zju}
      \item Fixed crust + spectral expansion~\cite{Lindblom:2010bb}
    \end{itemize}
...
\begin{frame}{EOS inference systematics in ET}
  ...
  \begin{itemize}
    ...
    \item \red{Preliminary results} to kickstart brainstorming
...
\begin{frame}{EOS inference systematics in ET: Results}
  ...
  Inference is \red{scalable}: able to investigate systematics in EOS inference 
...
\begin{frame}{Conclusion}
  ...
  \begin{itemize}
    ...
    \item First results for ET BNSs

    \vspace{\x}

    \item Open floor: what direction to take for ET div. 6 roadmap?
  \end{itemize}
