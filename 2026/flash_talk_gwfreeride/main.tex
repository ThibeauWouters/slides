...
\begin{frame}{Closing thoughts}
  ...
  \begin{itemize}
    \item \jaxtwo{\textbf{Neural priors}}: encode non-trivial prior information (including uncertainties) (cf. Matthew's talk)

    \vspace{\y}
    
    \item Implemented in \textsc{bilby}, but works with any stochastic sampler
    \begin{itemize}
      \item Appealing for GPU-based samplers
    \end{itemize}
    ...
    \item Another example of `informed' sampling (cf. Michael's talk): ML used inside traditional samplers
