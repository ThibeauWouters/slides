...
\author[Thibeau Wouters]{\textbf{Thibeau Wouters}, Peter T. H. Pang, Tim Dietrich, Chris Van Den Broeck \\ \vspace{2mm} \\ \href{https://arxiv.org/abs/2511.22987}{\texttt{arXiv:2511.22987}} \\ \href{mailto:t.r.i.wouters@uu.nl}{t.r.i.wouters@uu.nl} \newline \github \quad \linkedin \quad \myemail}
  ...
  \begin{tikzpicture}[remember picture,overlay]
    \node[fill=customblue, fill opacity=0.75, text opacity=1, rounded corners=10pt, inner sep=15pt] at (current page.center) {
      \begin{minipage}{0.8\textwidth}
        ...
        \href{https://arxiv.org/abs/2511.22987}{\texttt{arXiv:2511.22987}} \\[0.5ex]
...
\begin{frame}{Motivation}
  ...
  \begin{itemize}
    ...
    \item This work: neutron stars (NSs) and information from
    \begin{itemize}
...
\begin{frame}{Construction of neural priors}
  ...
  \begin{enumerate}
    ...
    \item Draw EOS curve: determines $\MTOV$, $\Lambda(m)$
...
\begin{frame}{Conclusion}
  ...
  \begin{itemize}
    \item GW PE often uses agnostic priors, missing valuable information
    ...
    \begin{enumerate}
      ...
      \item \textbf{Informed posteriors} (narrower, higher $d_L$)
    \end{enumerate}
